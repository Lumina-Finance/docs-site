...
Before you begin, make sure [`APP_URL`](environment-variables.md#app_url) matches the domain you use to access Lumina Finance, since Lumina Finance uses it to create the links in those emails. Then, add your provider's settings to `.env`:
